...
class ArtiAttrType(Enum):
    ...
    HP = "FIGHT_PROP_HP"
    SHIELD_COST_MINUS_RATIO = "FIGHT_PROP_SHIELD_COST_MINUS_RATIO"
    HEALED_ADD = "FIGHT_PROP_HEALED_ADD"
    SKILL_CD_MINUS_RATIO = "FIGHT_PROP_SKILL_CD_MINUS_RATIO"
    SPEED_PERCENT = "FIGHT_PROP_SPEED_PERCENT"
    PHYSICAL_SUB_HURT = "FIGHT_PROP_PHYSICAL_SUB_HURT"
    ADD_HURT = "FIGHT_PROP_ADD_HURT"
    SUB_HURT = "FIGHT_PROP_SUB_HURT"
